...
# Used units: meters (m), minutes (min)
...
# Kind_of_process: how the process is applied? by lenght, by area, by unit.
...
Model_1 = Model("Name", 430.40, 11615.59, 320.10, 1.00, 1.00, 1.00, Varioplus)
